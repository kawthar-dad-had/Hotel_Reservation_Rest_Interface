    ...
    <div>
      <Card>
        ...
        <CardContent>
          ...
          <Typography>Agence: {hotel.hotel.tarifsAgences[0].nom}</Typography>
...
const SearchAndFilter = ({ setHotels }: { setHotels: any }) => {
  ...
  const handleFilterSubmit = async() => {
      ...
      axios.get('http://localhost:8080/comparateurservice/api/comparateur', {
        params: formData,
      })  .then(response => {
